 ...
 *
 * @param {object} params
 * @param {string} [params.query] - Search text (optional with a structured filter)
 * @param {string} [params.category] - Category slug filter
 * @param {string} [params.ecosystem] - Ecosystem filter (js, swift, xcframework)
 * @param {string} [params.distribution] - Distribution mode filter (free, marketplace, pool, private)
