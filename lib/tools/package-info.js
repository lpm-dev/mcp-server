...
export function getInstallMethod(packageType, ecosystem) {
	// Source-extract types always use `lpm add`
	...
	// Swift/XCFramework use `lpm install` (SE-0292 registry mode)
	...
	// JS dependencies/libraries use `lpm install`
	...
	// Default: lpm install for managed dependencies
	return {
		command: "lpm install",
		description: "Installs as a managed dependency",
	}
}
